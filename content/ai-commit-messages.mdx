...
- **OpenAI-compatible** — a base URL, a model name, and a key when the server wants one. That covers OpenAI itself (`https://api.openai.com/v1`), a local [Ollama](https://ollama.com) or LM Studio (`http://localhost:11434/v1`), or a gateway of your own. FinderGit appends `/chat/completions`.
