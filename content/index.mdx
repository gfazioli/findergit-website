...
- **Tree view with sortable columns** — drill into any root folder like Finder's list view, with columns for Branch, Status, Size, and Date Modified — plus GitHub-driven columns for Issues, PRs, and Stars on repos that point at github.com
