...
A fork whose history has **diverged** (it has its own commits *and* is missing upstream commits) can't be fast-forwarded. FinderGit says so and leaves it to you to merge or rebase from upstream deliberately.
