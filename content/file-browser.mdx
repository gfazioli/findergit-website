...
- **+** button in the sidebar toolbar opens the macOS Open panel
...
![Sidebar with the filter field active and a virtual group expanded](/screenshot-sidebar-groups.png)
...
- **+ Group** button (folder icon) opens a small dialog to create a virtual group — Tower-style containers that hold roots without changing anything on disk. Useful when you want to keep work, side projects, and dotfiles visually separated
...
![Native Markdown preview shown on Space](/screenshot-feature-markdown.png)
