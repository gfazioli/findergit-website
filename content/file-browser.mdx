...
The sidebar on the left lists every **root folder** you've added — directories where FinderGit scans for Git repositories. Pinned above them are two global dashboards — **[Overview](/docs/overview)** and **[Account](/docs/account)** — that aren't tied to any single repository.

![The sidebar — Overview and Account pinned above your root folders and virtual groups](/screenshot-sidebar-groups.png)
...
- Name, Branch, Status, Changes, Issues, PRs, Stars, Size, Date Modified
