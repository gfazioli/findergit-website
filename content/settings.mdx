...
![Settings → Git showing Commit History stepper and GitHub Token panel](/screenshot-settings-git.png)

### Commit History
How many recent commits the **Commits** tab lists in the [Detail Panel](/docs/detail-panel#commits). Default: **4** — keeps the tab skim-friendly. Range: 1 to 50. Takes effect on next refresh or repo selection.
