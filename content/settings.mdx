...
### Privacy
Your staged diff is sent to the FinderGit Vercel proxy, which forwards it to Groq under a server-managed API key. **Diffs are not logged or stored.** Capped at 100 KB per request, with an additional 2 KB cap on custom instructions.
