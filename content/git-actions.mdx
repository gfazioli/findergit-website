...
![Repository detail panel with changes list, Stage/Unstage and commit area](/screenshot-feature-ai-commit.png)
...
- **Unstaged Changes (N)** — files modified or untracked in the working tree, not yet picked up
