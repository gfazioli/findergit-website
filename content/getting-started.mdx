...
You can **drag** roots to reorder them and **group** related projects together — Tower-style virtual containers that organise roots without touching anything on disk. See [File Browser → Sidebar](/docs/file-browser#sidebar) for the full breakdown.
